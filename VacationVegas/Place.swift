...
class Place {
    ...
    static var previewPlaces: [Place] {
        [
            Place(name: "Bellagio", latitude: 36.1129, longitude: -115.1765, interested: false),
            Place(name: "Stratosphere", latitude: 36.1475, longitude: -115.1556, interested: false),
            Place(name: "Luxor", latitude: 36.0975, longitude: -115.1761, interested: true),
            Place(name: "Excalibur", latitude: 36.0988, longitude: -115.1724, interested: false),
            Place(name: "Treasure Island", latitude: 36.1247, longitude: -115.1721, interested: false),
            Place(name: "Paris", latitude: 36.1129, longitude: -115.1765, interested: true),
        ]
    }
}
